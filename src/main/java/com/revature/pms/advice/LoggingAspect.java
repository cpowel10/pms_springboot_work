...
public class LoggingAspect {
    ...
    public void doLog() {
        logger.info("###1.I am doing the logging from aspect");
    }

    @After("execution(* com.revature.pms.services.ProductServiceImpl.*(..))")
    public void doSecurityCheck() {
        logger.info("###2.I am doing security checking");
    }
...
//        //here you can decide whether to complete method or not
//        joinPoint.proceed();
//        logger.info("###4.I am done with the transaction after");
//    }
}